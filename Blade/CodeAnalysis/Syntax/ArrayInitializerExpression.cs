...
{
    public sealed class ArrayInitializerExpression : ExpressionSyntax
    {
        public ArrayInitializerExpression(SyntaxToken openBracketToken, SeparatedSyntaxList<ArrayElementSyntax> arrayElements, SyntaxToken closeBracketToken, TypeClauseSyntax typeClauseSyntax)
        {
